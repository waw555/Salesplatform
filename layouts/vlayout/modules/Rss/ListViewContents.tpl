                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            {vtranslate('LBL_NOT_FOUND')} {vtranslate($MODULE, $MODULE)}. {vtranslate('LBL_CREATE')} <a class="rssAddButton" href="#" data-href="{$QUICK_LINKS['SIDEBARLINK'][0]->getUrl()}">{vtranslate($SINGLE_MODULE, $MODULE)}</a>
