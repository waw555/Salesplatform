		...
		<div class="pull-right">
			...
			<div>
				...
				<div class="span12 row-fluid">
				    ...
				    <div class="span10"><p class="pull-left"><small><strong>{vtranslate($RULE_MODEL->get('subjectop'),$QUALIFIED_MODULE)}</strong></small></p>&nbsp;&nbsp;&nbsp;{$RULE_MODEL->get('subject')}</div>
				...
				<div class="span12 row-fluid">
                    ...
                    {* SalesPlatform.ru begin *}
				    <div class="span10"><p class="pull-left"><small><strong>{vtranslate($RULE_MODEL->get('bodyop'),$QUALIFIED_MODULE)}</strong></small></p>&nbsp;&nbsp;&nbsp;{$RULE_MODEL->get('body')}</div>
